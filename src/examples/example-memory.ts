...
async function run() {
    ...
    console.log(`[1/${STEP_COUNT}] formatting an in-memory kv-fs volume...`);
    ...
    console.log(`[2/${STEP_COUNT}] creating test files under /home/florin/...`);
    ...
    console.log(`[3/${STEP_COUNT}] reading test files back...`);
    ...
    console.log(`[4/${STEP_COUNT}] walking the directory tree:`);
